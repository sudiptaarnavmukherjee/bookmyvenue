      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-4 text-gray-600">
                  ...
                  {venue.bookingCount !== undefined && venue.bookingCount > 0 && (
                    <span className="text-sm text-gray-500">({venue.bookingCount} bookings)</span>
                  )}
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="glass-card rounded-3xl p-6 sticky top-8 animate-in fade-in slide-in-from-bottom-4 duration-300 delay-200">
              {/* View Counter */}
