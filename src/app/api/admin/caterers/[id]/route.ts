  ...
  try {
    ...
    const updated = await prisma.caterer.update({
      ...
      data: {
        ...
        ...(minPlatePrice !== undefined && { minPlatePrice: minPlatePrice ? parseFloat(minPlatePrice) : null }),
        ...(silverPrice !== undefined && { silverPrice: silverPrice ? parseFloat(silverPrice) : null }),
        ...(goldPrice !== undefined && { goldPrice: goldPrice ? parseFloat(goldPrice) : null }),
        ...(platinumPrice !== undefined && { platinumPrice: platinumPrice ? parseFloat(platinumPrice) : null }),
