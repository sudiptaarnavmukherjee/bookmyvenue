          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Fishbowl listing ΓÇó Call to book</p>
              </div>
            </div>
            <button
              type="submit"
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs text-gray-500 mb-1">Price per plate (Γé╣)</label>
                  <input
                    type="number"
                    name="silverPrice"
            ...
            <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs text-yellow-600 mb-1">Price per plate (Γé╣)</label>
                  <input
                    type="number"
                    name="goldPrice"
            ...
            <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs text-purple-600 mb-1">Price per plate (Γé╣)</label>
                  <input
                    type="number"
                    name="platinumPrice"
